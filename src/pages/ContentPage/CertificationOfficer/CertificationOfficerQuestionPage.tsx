...
import CPTHYNR from "../../../mock-data/Certification/officer/CPTHYNR.json";
import WORD from "../../../mock-data/Certification/officer/WORD.json";
import SMJDHSEGS from "../../../mock-data/Certification/officer/SMJDHSEGS.json";
...
export default function CertificationOfficerQuestionPage() {
  ...
  const handleSubmit = () => {
    ...
    navigate(`/study-certification/officer/${parsedSubjectId}/result`, {
      state: {
        ...
        score,
        results,
        retryPath: `/study-certification/officer/${parsedSubjectId}`,
    ...
    <div className="p-6 md:p-8">
      <div className="mx-auto max-w-6xl space-y-10">
        <QuestionHeader
          ...
          totalCount={questions.length}
          timeLeft={timeLeft}
          backPath="/study-certification/officer"
        />
