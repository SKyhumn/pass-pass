...
import GINMS from "../../../mock-data/Certification/hr/GINMS.json";
import HRM from "../../../mock-data/Certification/hr/HRM.json";
import ERP from "../../../mock-data/Certification/hr/ERP.json";
...
export default function CertificationHrQuestionPage() {
  ...
  const handleSubmit = () => {
    ...
    navigate(`/study-certification/hr/${parsedSubjectId}/result`, {
      state: {
        ...
        score,
        results,
        retryPath: `/study-certification/hr/${parsedSubjectId}`,
    ...
    <div className="p-6 md:p-8">
      <div className="mx-auto max-w-6xl space-y-10">
        <QuestionHeader
          ...
          totalCount={questions.length}
          timeLeft={timeLeft}
          backPath="/study-certification/hr"
        />
