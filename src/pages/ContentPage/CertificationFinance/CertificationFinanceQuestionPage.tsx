...
import TJJSUYS from "../../../mock-data/Certification/finance/TJJSUYS.json";
import AFPK from "../../../mock-data/Certification/finance/AFPK.json";
import EHFP from "../../../mock-data/Certification/finance/EHFP.json";
...
export default function CertificationFinanceQuestionPage() {
