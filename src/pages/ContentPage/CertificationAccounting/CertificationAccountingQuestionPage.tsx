...
import JSHG1 from "../../../mock-data/Certification/accounting/JSHG1.json";
import JSSM1 from "../../../mock-data/Certification/accounting/JSSM1.json";
import JGGRS from "../../../mock-data/Certification/accounting/JGGRS.json";
...
export default function CertificationAccountingQuestionPage() {
  ...
  const handleSubmit = () => {
    ...
    navigate(`/study-certification/accounting/${parsedSubjectId}/result`, {
      state: {
        ...
        score,
        results,
        retryPath: `/study-certification/accounting/${parsedSubjectId}`,
    ...
    <div className="p-6 md:p-8">
      <div className="mx-auto max-w-6xl space-y-10">
        <QuestionHeader
          ...
          totalCount={questions.length}
          timeLeft={timeLeft}
          backPath="/study-certification/accounting"
        />
