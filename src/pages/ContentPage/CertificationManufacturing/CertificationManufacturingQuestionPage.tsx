...
import PJGYGS from "../../../mock-data/Certification/manufacturing/PJGYGS.json";
import SEAJGS from "../../../mock-data/Certification/manufacturing/SEAJGS.json";
import SSJDHGS from "../../../mock-data/Certification/manufacturing/SSJDHGS.json";
...
export default function CertificationManufacturingQuestionPage() {
  ...
  const handleSubmit = () => {
    ...
    navigate(`/study-certification/manufacturing/${parsedSubjectId}/result`, {
      state: {
        ...
        score,
        results,
        retryPath: `/study-certification/manufacturing/${parsedSubjectId}`,
    ...
    <div className="p-6 md:p-8">
      <div className="mx-auto max-w-6xl space-y-10">
        <QuestionHeader
          ...
          totalCount={questions.length}
          timeLeft={timeLeft}
          backPath="/study-certification/manufacturing"
        />
